...
#define VENDOR_LIB_CONF_PATH "/vendor/etc"
#endif
...
#define FW_PATCHFILE_LOCATION "/vendor/soc_platform/firmware/"  /* maguro */
#endif

#ifndef DATMISC_MAC_ADDR_PATH
#define DATMISC_MAC_ADDR_PATH "/data/bluetooth/btmac.txt"
#endif
