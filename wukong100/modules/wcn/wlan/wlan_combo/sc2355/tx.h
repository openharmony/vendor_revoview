...
#define SPRD_AP_GO_DEFAULT_LUT	4
/* sap/go may use lut3 and lut5 to send unicast frame, more
 * info can ref bug:2928689
 */
#define SPRD_AP_REUSE_LUT5	5
#define SPRD_AP_REUSE_LUT3	3

/* used for optimize mcc tx throughput */
#define STATION_CTXID			0
#define SAP_CTXID			1
#define MCC_DEFAULT_HOLD_CTXID		3
#define SPRD_MCC_WINDOW_MIN		10
#define CHANNEL_SWITCH_TIME_2G		10
#define CHANNEL_SWITCH_TIME_5G		4
...
#define HANG_RECOVERY_ACKED	2
	...
	struct timer_list tx_hold_timer;
	unsigned char tx_hold_flag;
	unsigned char tx_hold_ctxid;
	atomic_t sipc_tx_cred[SPRD_MODE_MAX];
};
