...
/* wpa3 11R */
#define SPRD_AKM_SUITE_WPA3_FT			(9)
...
static const u32 sprd_akm_suites[] = {
	...
	/* required by wpa3 11R */
	WLAN_AKM_SUITE_FT_OVER_SAE,
//	WLAN_AKM_SUITE_8021X_SUITE_B_192,
	WLAN_AKM_SUITE_OWE,
};

static const struct wiphy_iftype_akm_suites sprd_iftype_akm_suites[] = {
	{
		.iftypes_mask = BIT(NL80211_IFTYPE_STATION),
		.akm_suites = sprd_akm_suites,
		.n_akm_suites = ARRAY_SIZE(sprd_akm_suites)
	}
};
