...
enum vendor_cmd_id {
	...
	/* cmds outside of _NL80211_VENDOR_SUBCMD_ in wifi_hal */
	VENDOR_CMD_GET_THERMAL_VAL = 0x10000,
	VENDOR_CMD_GET_IFACE_CONCURRENCY_MATRIX = 0x10001,
	VENDOR_CMD_GET_IFACE_NAME = 0x10002,
...
/*end of get iface concurrency matrix---0x10001*/
...
struct wifi_iface_combination {
	...
	/* Interface limits */
	const struct wifi_iface_limit *iface_limits;
};
...
struct wifi_iface_concurrency_matrix {
	...
	const struct wifi_iface_combination *iface_combinations;
};
...
enum vendor_attr_iface_concurrency_matrix {
	ATTR_IF_CO_INVALID = 0,
	ATTR_IF_CO_MATRIX,
	ATTR_IF_CO_NUM_IFACE_COMBOS,
	ATTR_IF_CO_IFACE_COMBOS,
	/* keep last */
	ATTR_IF_CO_AFTER_LAST,
	ATTR_IF_CO_MAX =
	ATTR_IF_CO_AFTER_LAST - 1,
};

enum vendor_attr_iface_combo {
	ATTR_IF_COMBO_INVALID = 0,
	ATTR_IF_COMBO_LIMITS,
	ATTR_IF_COMBO_MAX_IFACES,
	ATTR_IF_COMBO_NUM_IFACE_LIMITS,
	/* keep last */
	ATTR_IF_COMBO_AFTER_LAST,
	ATTR_IF_COMBO_MAX =
	ATTR_IF_COMBO_AFTER_LAST - 1,
};

enum vendor_attr_iface_limit {
	ATTR_IF_LIMIT_INVALID = 0,
	ATTR_IF_LIMIT_MASK,
	ATTR_IF_LIMIT_MAX_LIMIT,
	/* keep last */
	ATTR_IF_LIMIT_AFTER_LAST,
	ATTR_IF_LIMIT_MAX =
	ATTR_IF_LIMIT_AFTER_LAST - 1,
};

/*end of get iface concurrency matrix---0x10001*/

/*start of get iface name---0x10002*/
enum vendor_attr_iface_name {
	ATTR_IFACE_NAME_INVALID = 0,
	ATTR_IFACE_TYPE,
	ATTR_IFACE_NAME,
	/* keep last */
	ATTR_IFACE_NAME_AFTER_LAST,
	ATTR_IFACE_NAME_MAX =
	ATTR_IFACE_NAME_AFTER_LAST - 1,
};

static const struct
nla_policy vendor_iface_name_policy[ATTR_IFACE_NAME_MAX + 1] = {
	[ATTR_IFACE_TYPE] = { .type = NLA_U32 },
};

/*end of get iface name---0x10002*/
#endif
